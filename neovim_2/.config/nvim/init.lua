...
-- [[ CMP ]
vim.o.completepot = 'menuone,noselect'
...
vim.keymap.set('n', '<leader>pf', ':Telescope fd<CR>', { desc = 'Find all files' })
vim.keymap.set('n', '<leader>pd', ':Telescope oldfiles<CR>', { desc = 'Find old files' })
vim.keymap.set('n', '<leader>ps', ':Telescope live_grep<CR>', { desc = 'Live grep' })
vim.keymap.set('n', '<leader>po', ':Telescope lsp_document_symbols<CR>', { desc = 'Find lsp workspace symbols' })
vim.keymap.set('n', '<leader>pt', ':Telescope buffers<CR>', { desc = 'Find open buffer' })
